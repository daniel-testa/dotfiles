...
PROMPT='
%{$fg_bold[blue]%}%{$fg_bold[red]%}%n@ %{$fg_bold[blue]%}%{$fg_bold[magenta]%} • %{$fg_bold[red]%}%{$fg_bold[green]%}%~%{$fg_bold[blue]%}%{$fg_bold[blue]%}%{$fg_bold[red]%}%{$reset_color%}
%{$fg[cyan]%} _ %{$reset_color%'
